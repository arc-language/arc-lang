...
NAMESPACE  : 'namespace';
LET        : 'let';
VAR        : 'var';         // heap ref-counted declaration / mutable reference type
CONST      : 'const';
FUNC       : 'func';
ASYNC      : 'async';
AWAIT      : 'await';
...
// new / delete — manual heap intrinsics AND extern cpp constructor/destructor markers
NEW    : 'new';
DELETE : 'delete';
...
// =============================================================================
// Extern Language Mode — pushed by EXTERN, popped by C_LANG / CPP_LANG
// =============================================================================
